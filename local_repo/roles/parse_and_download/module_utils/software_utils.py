...
def get_csv_file_path(software_name, user_csv_dir):
    ...
    status_csv_file_path = os.path.join(user_csv_dir, software_name, "status.csv")
...
def process_software(software, fresh_installation, json_path, csv_path, subgroup_list):
    ...
    return parse_json_data(json_path, PACKAGE_TYPES, failed_packages, subgroup_list) + rpm_tasks ,failed_packages
