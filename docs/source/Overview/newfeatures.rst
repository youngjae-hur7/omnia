...
* Enablement for AMD 17G servers - R6725, R7725, R6715, R7715
* Enablement for Intel Gaudi 3 GPU
* Enablement for NVIDIA GPUs - L40s, H100 NVL, H200 SXM
...
* Support for BCM RoCE with calico network plugin
